...
class RatingController: UIStackView {
    var starsRating = 0
    var starsEmptyPicName = "black_empty_star" // change it to your empty star picture name
    var starsFilledPicName = "black_filled_star" // change it to your filled star picture name
